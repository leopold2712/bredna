    ...
    <div className={styles.container}>
      ...
      <div className={styles.cards}>
        <div className={styles.card}>
          <img className={styles.card__pic} src={session} alt="session" />
          <img className={styles.card__corner} src={session_corner} alt="session_corner" />
          <div className={styles.card__price}>$45.00 per hour</div>
          <div className={styles.card__text}>Session time - 50 minutes</div>
        </div>

        <div className={styles.card}>
          <img className={styles.card__pic} src={messaging} alt="messaging" />
          <img className={styles.card__corner} src={messaging_corner} alt="messaging_corner" />
      ...
      <div className={styles.points}>
        <div className={styles.point}>
          <div className={styles.point__imgCnt}>
            <img className={styles.point__img} src={point} alt="point" />
          </div>
